...
export function SignInPage() {
  ...
  const form = useForm<SigninSchemaType>({
    ...
    defaultValues: {
      email: laravelAuth ? 'superadmin@school-saas.test' : 'demo@kt.com',
      password: laravelAuth ? 'password' : 'demo123',
      rememberMe: true,
    },
  });
      ...
      >
        ...
        <Alert appearance="light" size="sm" close={false}>
          ...
          <AlertTitle className="text-accent-foreground">
            {laravelAuth ? (
              <>
                Laravel Super Admin:{' '}
                <strong>superadmin@school-saas.test</strong> /{' '}
                <strong>password</strong>
                . Ensure the API is running ({import.meta.env.VITE_APP_API_URL || 'http://localhost:8000/api'}).
              </>
            ) : (
              <>
        ...
        <div className="flex flex-col gap-3.5">
          <Button
            ...
            disabled={isGoogleLoading || laravelAuth}
          >
            {isGoogleLoading ? (
